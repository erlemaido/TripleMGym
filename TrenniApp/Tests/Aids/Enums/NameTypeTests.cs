...
namespace TrainingApp.Tests.Aids.Enums {
    ...
    [TestClass] public class NameTypeTests : BaseTests {
        ...
        [TestMethod] public void MaidenTest() =>
            Assert.AreEqual(2, (int) NameType.Maiden);

        [TestMethod] public void NickTest() =>
            Assert.AreEqual(3, (int) NameType.Nick);

        [TestMethod] public void TradeTest() =>
            Assert.AreEqual(4, (int) NameType.Trade);

        [TestMethod] public void OtherTest() =>
