...
namespace TrainingApp.Tests.Aids.Extensions {
    ...
    [TestClass] public class DatesTests : BaseTests {
        ...
        [TestMethod] public void AddDaysSafeTest() {
        ...
        [TestMethod] public void AddHoursSafeTest() {
        ...
        [TestMethod] public void AddMinutesSafeTest() {
        ...
        [TestMethod] public void AddMonthsSafeTest() {
        ...
        [TestMethod] public void AddSecondsSafeTest() {
        ...
        [TestMethod] public void AddYearsSafeTest() {
        ...
        [TestMethod] public void AddSafeTest() {
            Assert.AreEqual(max, max.AddSafe(x));
            Assert.AreEqual(x.Add(t), x.AddSafe(y));
        }

        [TestMethod] public void SubtractSafeTest() {
        ...
        [TestMethod] public void IsDateOnlyTest() {
