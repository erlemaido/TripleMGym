...
namespace TrainingApp.Tests.Pages.SportsClub
{
    ...
    public class LocationsPageTests : AbstractClassTests<LocationsPage,
        CommonPage<ILocationsRepository, Location, CoachView, CoachData>>
    {
        private class TestClass : LocationsPage
        {
            internal TestClass(ILocationsRepository c, ITimetableEntriesRepository te, ITrainingsRepository t, ILocationsRepository l, ITrainingTypesRepository tt) : base(c, te, t, l, tt)
            {
            }
        }

        private class TestRepository : BaseTestRepositoryForUniqueEntity<Location, CoachData>, ILocationsRepository { }
